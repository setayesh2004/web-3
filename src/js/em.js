document.addEventListener("DOMContentLoaded", async () => {
  ...
  `;
    ...
    `;
      ...
      // *** فقط همین 3 خط تغییر کرده‌اند ***
      container.appendChild(col2); // ستون وسط
      container.appendChild(col3); // ستون چپ
      container.appendChild(col1); // ستون سه‌تایی → سمت راست
    } catch (err) {
  ...
  async function loadCategories() {
    try {
      ...
      // فعال‌سازی سوییپر بعد از ساخت اسلایدها
      // فعال‌سازی سوییپر بعد از ساخت اسلایدها
      new Swiper(".categoriesSwiper", {
        slidesPerView: 6,
        spaceBetween: 15,
        loop: true, // حلقه‌ای شدن
        autoplay: {
          delay: 2000, // هر 2 ثانیه حرکت کنه
          disableOnInteraction: false, // وقتی کاربر دکمه بزنه حرکت خودکار متوقف نشه
        },
        navigation: {
          nextEl: ".swiper-button-next",
          prevEl: ".swiper-button-prev",
  ...
  // ===== اسلایدر محصولات (بخش همین الان موجود شد...) =====
  ...
  async function loadNewProducts() {
    ...
    try {
      ...
      console.log(products); // بررسی داده‌ها
  ...
  async function loadbestSeller() {
    ...
    try {
      ...
      console.log(bestseller); // بررسی داده‌ها
  ...
  async function loadArticles() {
    try {
      ...
      wrapper.innerHTML = ""; // پاک‌سازی

      // ساخت مقالات بدون innerHTML+=
      ...
      // اجرای Swiper فقط یک‌بار
      new Swiper(".articlesSwiper", {
        slidesPerView: 1.2, // موبایل
        spaceBetween: 12,
        loop: false,
        ...
        breakpoints: {
          ...
          1024: {
            ...
            // ❌ غیر فعال کردن اسلاید برای دسکتاپ
  ...
  async function loadFooter() {
    try {
      ...
      <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 px-6 py-6 md:py-[20px]">
        ...
        <!-- ستون سمت راست: عکس فروشگاه + اینستاگرام -->
